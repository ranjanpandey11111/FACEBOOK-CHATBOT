...
/*
 * TODO:
 *https://wit.ai/ranjanpandey11111
...
function processMessage(sender, reqText) {
    ...
    }else if(reqText.indexOf('hi') > -1){
        console.log("ffghhh",sender);
          respText="I am Anuska , MBA student from Rural Developemnt , I am starting ngo so please like share and follow my page for my initiative.!!"
          sendTextMessage(sender, respText);
    } else {
        // Unknown command
        console.log(respText);
...
app.get('/', function(req, res) {
    res.send('Test Facebook Chatbot.');
});

app.get('/webhook/', function (req, res) {
    console.log("got connected hare")
    if (req.query['hub.verify_token'] === FACEBOOK_PAGE_ACCESS_TOKEN) {
